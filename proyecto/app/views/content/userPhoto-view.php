<div class="container is-fluid mb-6">
	<?php 
		...
		if($id==$_SESSION['id']){  //mostrara la informacion de la pagina dependiendo si es en el mismo perfil o en el de otro
	?>
...
<div class="container pb-6 pt-6">
	<?php
		...
		$datos=$insLogin->seleccionarDatos("Unico","usuario","usuario_id",$id); // utiliza la consulta para seleccionar datos
